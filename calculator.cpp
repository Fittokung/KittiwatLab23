...
char Text1[20];
char Text2[20];
HWND Text_Field,Button,TextBox1,TextBox2;
	...
	switch(Message) {
			case WM_CREATE:
				...
				TextBox1 = CreateWindow("EDIT",
                          " ",
                          WS_BORDER|WS_CHILD|WS_VISIBLE,50,50,150,25,hwnd,NULL,NULL,NULL);
				TextBox2 = CreateWindow("EDIT",
                          " ",
                          WS_BORDER|WS_CHILD|WS_VISIBLE,50,80,150,25,hwnd,NULL,NULL,NULL);
